...
// FIXME Step-5-1: 「EmployeeBean, ResponseBean, ConstMessage, ConstSQL, EmployeeDao, SC5Exception, Logger」をインポートしなさい。ok
// [ここへ記述]
// Logger以外はデフォルトでインポート済みを確認
    ...
    private void executeSelectQuery(final ExecuteCase eCase, final List<EmployeeBean> pEmployeeBeanList)
        ...
        try {
            ...
            case FIND_BY_EMPID:
                ...
                // FIXME Step-5-4: pEmployeeBeanListの「1件目の要素のみ」から社員情報を取得しなさい。ok
                ...
                if (Objects.nonNull(emp)) {
                    ...
                    // FIXME Step-5-5: 以下の手順に沿って適当な処理を記述しなさい。ok
                    ...
                    // FIXME Step-5-6: preparedStatementに適切なパラメーターをセットしなさい。ok
                    // Tips: パラメータをセットするインデックスに注意
                    // [ここへ記述]
                    preparedStatement.setString(1, empId);
                    
                    
                    // FIXME Step-5-7: preparedStatementよりSQL(SELECT文)を実行し、resultSetへ結果を格納しなさい。ok
                    // [ここへ記述]
